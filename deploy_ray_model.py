...
message = "hello this is global message"
...
class CustomDesploy:
    ...
    def __init__(self):
        ...
        self.new_message = "This name has been initialized"

    async def __call__(self, http_request):
        self.printSomething("Hello this is function call")
        body = await http_request.json()
        print(body["image_left"])
        print(body["image_right"])
        # res = {"response": "this is response"}
        left_result = self.detect_img(body["image_left"])
        right_result = self.detect_img(body["image_right"])
        result = {"left_data": left_result,
                  "right_data": right_result}
        print(result)
        return result
    ...
    def run_detector(self, detector, path):
        ...
        inferenceData = {"entities": result["detection_class_entities"].tolist(),
    ...
    def detect_img(self, image_url):
        ...
        result = self.run_detector(self.detector, image_path)
        end_time = time.time()
        print("Inference time:", end_time - start_time)
        return result


CustomDesploy.deploy()
